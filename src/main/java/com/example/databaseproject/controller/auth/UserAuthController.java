...
public class UserAuthController {
    ...
    @PostMapping("/sign-up")
    @CrossOrigin(origins = {"http://localhost:3000", "https://localhost:3000", "http://localhost:3000/register"})
    ...
    @PostMapping("/sign-in")
    @CrossOrigin(origins = {"http://localhost:3000", "https://localhost:3000", "http://localhost:3000/login"})
